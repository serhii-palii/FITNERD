...
const translations = {
  ...
  uk: {
    ...
    feature3Title: "Ноль соціальної тривоги",
    feature3Desc:
    ...
    betaResults: "Результати Beta (реальні дані)",
    statsTitle: "Виявляється, людям це подобається. Сильно.",
    stat1Label: "бета-тестерів тренуються",
    stat1Sub: "з 2000+ хто подався (ми прискіпливі af)",
    ...
    testimonial3:
      "Як хтось з 47 табличками що трекає все, це app моєї мрії. Деталі метрик просто *chef's kiss*",
